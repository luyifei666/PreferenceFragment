...
public class OrderManageListActivity extends BaseActivity implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void addHeadView() {
        ...
        headView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(OrderManageListActivity.this, "change complete", Toast.LENGTH_LONG).show();
            }
        });
...
//                    pullToRefreshAdapter.loadMoreEnd();//default visible
                ...
                if (isErr) {
                    ...
                    isErr = true;
                    Toast.makeText(OrderManageListActivity.this, R.string.network_err, Toast.LENGTH_LONG).show();
...
//        pullToRefreshAdapter.setPreLoadNumber(3);
        ...
        mRvList.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(final BaseQuickAdapter adapter, final View view, final int position) {
                Intent it;
                it = new Intent(OrderManageListActivity.this, OrderManageDetailActivity.class);
                startActivity(it);
