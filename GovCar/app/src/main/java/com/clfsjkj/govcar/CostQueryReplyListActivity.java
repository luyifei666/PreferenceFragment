...
import com.clfsjkj.govcar.ItemAdapter.CostQueryReplyListAdapter;
...
public class CostQueryReplyListActivity extends BaseActivity implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    //质疑回复列表
    ...
    private CostQueryReplyListAdapter pullToRefreshAdapter;
    ...
    private void addHeadView() {
        ...
        headView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(CostQueryReplyListActivity.this, "change complete", Toast.LENGTH_LONG).show();
            }
        });
...
//                    pullToRefreshAdapter.loadMoreEnd();//default visible
                ...
                if (isErr) {
                    ...
                    isErr = true;
                    Toast.makeText(CostQueryReplyListActivity.this, R.string.network_err, Toast.LENGTH_LONG).show();
    ...
    private void initAdapter() {
        pullToRefreshAdapter = new CostQueryReplyListAdapter();
...
//        pullToRefreshAdapter.setPreLoadNumber(3);
        ...
        mRvList.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(final BaseQuickAdapter adapter, final View view, final int position) {
                Intent it;
                it = new Intent(CostQueryReplyListActivity.this, CostQueryReplyDetailActivity.class);
