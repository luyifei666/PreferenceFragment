...
import com.clfsjkj.govcar.ItemAdapter.UserEvaluationListAdapter;
...
public class UserEvaluationListActivity extends BaseActivity implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    //用车评价列表
    ...
    private UserEvaluationListAdapter pullToRefreshAdapter;
    ...
    private void addHeadView() {
        ...
        headView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(UserEvaluationListActivity.this, "change complete", Toast.LENGTH_LONG).show();
            }
        });
...
//                    pullToRefreshAdapter.loadMoreEnd();//default visible
                ...
                if (isErr) {
                    ...
                    isErr = true;
                    Toast.makeText(UserEvaluationListActivity.this, R.string.network_err, Toast.LENGTH_LONG).show();
    ...
    private void initAdapter() {
        pullToRefreshAdapter = new UserEvaluationListAdapter();
...
//        pullToRefreshAdapter.setPreLoadNumber(3);
        ...
        mRvList.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(final BaseQuickAdapter adapter, final View view, final int position) {
                Intent it;
                it = new Intent(UserEvaluationListActivity.this, UserEvaluationActivity.class);
                startActivity(it);
