...
public class EmergencyDispatchCarActivity extends BaseActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        switch (position) {
                            case 0: // 直接调起相机
                                ...
                                Intent intent = new Intent(EmergencyDispatchCarActivity.this, ImageGridActivity.class);
                            ...
                            case 1:
                                //打开选择,本次允许选择的数量
                                ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                                Intent intent1 = new Intent(EmergencyDispatchCarActivity.this, ImageGridActivity.class);
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_car_start://起始地
                it = new Intent(EmergencyDispatchCarActivity.this, BaiduMapPoiActivity.class);
