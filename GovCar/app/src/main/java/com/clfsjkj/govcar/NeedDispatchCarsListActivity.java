...
public class NeedDispatchCarsListActivity extends BaseActivity implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_need_dispatch_cars);
    ...
    private void addHeadView() {
        ...
        headView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(NeedDispatchCarsListActivity.this, "change complete", Toast.LENGTH_LONG).show();
            }
        });
...
//                    pullToRefreshAdapter.loadMoreEnd();//default visible
                ...
                if (isErr) {
                    ...
                    isErr = true;
                    Toast.makeText(NeedDispatchCarsListActivity.this, R.string.network_err, Toast.LENGTH_LONG).show();
...
//        pullToRefreshAdapter.setPreLoadNumber(3);
        ...
        mRvList.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(final BaseQuickAdapter adapter, final View view, final int position) {
                Intent it;
                it = new Intent(NeedDispatchCarsListActivity.this, NeedDispatchCarsDetailActivity.class);
