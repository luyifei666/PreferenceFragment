...
//        mRecyclerView.setFocusable(false);
        ...
        btnStatus.setVisibility(View.VISIBLE);
        btnReject.setText("撤销订单");
        btnPass.setText("删除订单");
    ...
    private void initAdapter() {
        ...
        BaseQuickAdapter enclosureAdapter = new EnclosureAdapter(R.layout.enclosure_list_item, mDataList, OrderManageDetailActivity.this);
            ...
            case R.id.tv_car_use_contacts_tel:
                if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_CONTACTS)) {
                        ...
                        // 申请授权。
                        ActivityCompat.requestPermissions(OrderManageDetailActivity.this, new String[]{Manifest.permission.CALL_PHONE}, PERMISSION_CALL_PHONE_CONTACT);
                    }
                } else {
                    // 有权限了，去放肆吧。
            ...
            case R.id.tv_car_user_tel:
                if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_CONTACTS)) {
                        ...
                        // 申请授权。
                        ActivityCompat.requestPermissions(OrderManageDetailActivity.this, new String[]{Manifest.permission.CALL_PHONE}, PERMISSION_CALL_PHONE_USERTEL);
                    }
                } else {
                    // 有权限了，去放肆吧。
