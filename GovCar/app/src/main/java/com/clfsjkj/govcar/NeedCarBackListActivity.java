...
public class NeedCarBackListActivity extends BaseActivity implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void addHeadView() {
        ...
        headView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(NeedCarBackListActivity.this, "change complete", Toast.LENGTH_LONG).show();
            }
        });
...
//                    pullToRefreshAdapter.loadMoreEnd();//default visible
                ...
                if (isErr) {
                    ...
                    isErr = true;
                    Toast.makeText(NeedCarBackListActivity.this, R.string.network_err, Toast.LENGTH_LONG).show();
